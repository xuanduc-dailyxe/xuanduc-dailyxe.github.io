...
$(document).ready(function () {
    ...
    // TranXuanDuc Slider banner top với sự kiện chọn màu trong hình banner để set background color cho toàn khối banner.
    var imgPickMainColor;
    var palette;
    $('.owl-sliderbanner-top').owlCarousel({
        smartSpeed: 0,
        loop: true,
        items: 1,
        margin: 0,
        ...
        // Get "src" image in banner.
        imgPickMainColor = document.getElementsByClassName("owl-sliderbanner-top")[0].getElementsByClassName("owl-item")[e.item.index].getElementsByTagName("img")[0]
        if (imgPickMainColor) {
            // Get color in image to set background banner.
            palette = areaPalette(imgPickMainColor, {
                w: 200,
                h: 40,
                x: '1%',
                y: '1%',
            ...
            // set background in banner.
            $(".banner-top").css("background-color", palette[0].hex);
        }
    });
    ...
    $(".navbar-nav .caret").on('click touch', function (e) {
        e.preventDefault();
        if ($(window).width() < 992) {
    ...
    $('#back-top').on('click touch', function (e) {
    ...
    $('.zippy-content a[href*="#"]:not([href="#"])').click(function (e) {
    ...
    $('a.link-scroll[href*="#"]:not([href="#"])').click(function (e) {
        if (location.hostname == this.hostname) {
            var target = $(this.hash);
            target = target.length ? target : $('[name=' + this.hash.slice(1) + ']');
            if (target.length) {
    ...
    // TranXuanDuc Xử lý sự kiện active tab khi mở modal trong chi tiết sản phẩm.
    var owlCarouselLoaded = false;
    var slider = $('.owl-gallery-images');
    ...
    $(".modal").on('show.bs.modal', function(e) {
        ...
        if(!owlCarouselLoaded){
            slider.owlCarousel({
                ...
                setSelectedItemThums(e.item.index);
            });
            thumbs.owlCarousel({
                loop: false,
                navText: ["", ""],
    ...
    function setSelectedItemThums(selectedIndex) {
        thumbs.find(".owl-item").removeClass("selected");
        thumbs.find(".owl-item").eq(selectedIndex).addClass("selected");
    }
    ...
    $(".wrap-content .show-more .btn").on("click touch", function () {
        ...
        if (!$(this).hasClass("show")) {
            ...
            $(this).addClass("show");
            $(this).closest('.wrap-content').find('.detail-content').removeClass("max-height");
            ...
            $(this).closest('.wrap-content').find('.detail-content').addClass("max-height");
        }
    });
    $('.wrap-content').each(function () {
        var height = parseInt($(this).outerHeight());
        if (height && height < 400) {
            $(this).find('.detail-content').removeClass('max-height');
...
// TranXuanDuc 20210830 Get color in image
...
// Spinner nhậo số lượng trong chi tiết sản phẩm 
$(function () {
