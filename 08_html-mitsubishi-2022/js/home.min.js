...
$(document).ready(function () {
    ...
    // Kiểm tra click vào menu
    $('.navbar .navbar-collapse .dropdown').on('show.bs.dropdown', function () {
        $("body").addClass("is-noscroll");
    })

    $('.navbar .navbar-collapse .dropdown').on('hidden.bs.dropdown', function () {
        $("body").removeClass("is-noscroll");
    })

    // Ẩn menu khi cuộn xuống
    var lastScrollTop = 0; 
    ...
    // Event collapse footer
    $(".footer-block-title").on('click touch', function () {
